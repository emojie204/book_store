...
public class AddGenre extends javax.swing.JFrame {
     ...
     */
    public static String genreName1 ="";
    public AddGenre() {
        initComponents();
        loadData();
        name.enable(false);
    ...
    public int getIdGenre(String genreName){
        int id = 0;
        try{
     ...
     private void loadData(){
        ...
        String nameGenre = rs.getString("name");
        
        model.addRow(new Object[]{id,nameGenre});
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        // TODO add your handling code here:
         String txtName = this.name.getText().trim();
        boolean isExist = false;
        try{
        
            String sql = "Select * From genre where name = '"+txtName+"' ";
        ...
        if(isExist == true){
             JOptionPane.showMessageDialog(new JFrame(), "Genre Name:"+txtName+" is exist",
    ...
    private void jTable1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MousePressed
        ...
        String ids = jTable1.getModel().getValueAt(rowIndex, 0).toString();
        String  genreName = jTable1.getModel().getValueAt(rowIndex, 1).toString();
//        System.out.println("id : "+id);
        genreName1 = genreName;
        
        tfId.setText(ids);
        name.setText(genreName);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        // TODO add your handling code here:
//        int id = Integer.parseInt(genreName1)
            String genreName = name.getText().trim();
